...
public class registration_GUI extends JFrame {
    ...
    private class RegisterAction implements ActionListener {
        ...
        {
            String firstName = firstNamewfield.getText();
            ...
            if (!isValid(emailId)) {
                ...
                else
                {
                    try {
                        ...
                        JOptionPane.showMessageDialog(null,"Connection Failed. Check details.", "Error", JOptionPane.ERROR_MESSAGE);
                        e1.printStackTrace();
                    } catch (SQLException e1) {
                        JOptionPane.showMessageDialog(null,"Please enter all mandatory fields.", "Error", JOptionPane.ERROR_MESSAGE);
                        e1.printStackTrace();
                    }
